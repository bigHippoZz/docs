...
// @author       楼教主
// @license      MIT
// @homepageURL  https://githubc.om/52cik/github-hans
...
(function (window, document, undefined) {
    ...
    function timeElement() {
        ...
        var RelativeTimeElement$getFormattedDate =
            RelativeTimeElement.prototype.getFormattedDate;
        var TimeAgoElement$getFormattedDate =
            TimeAgoElement.prototype.getFormattedDate;
        ...
        var times = document.querySelectorAll(
            "time, relative-time, time-ago, local-time"
        );
